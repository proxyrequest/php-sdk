...
/**
 * ProvidersResource Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
...
class ProvidersResource
{
    ...
    /**
     * Operation listDataBalancesWithResponse
     *
    ...
    /**
     * Operation listDataBalancesWithHttpInfo
     *
     * List provider data balances
     *
     * @param  int|null $limit Number of results to return per page. (optional)
  ...
  200 => '\\ProxyRequest\\Dto\\PaginatedProviderDataBalanceList',
    ...
    /**
     * Operation listDataBalancesAsync
     *
     * List provider data balances
     *
     * @param  int|null $limit Number of results to return per page. (optional)
    ...
    /**
     * Operation listDataBalancesAsyncWithHttpInfo
     *
     * List provider data balances
     *
     * @param  int|null $limit Number of results to return per page. (optional)
  ...
  200 => '\\ProxyRequest\\Dto\\PaginatedProviderDataBalanceList',
    ...
    /**
     * Create request for operation 'listDataBalances'
     *
     * @param  int|null $limit Number of results to return per page. (optional)
     * @param  int|null $offset The initial index from which to return the results. (optional)
     * @param  string|null $acceptLanguage Preferred language for human-readable API errors. Supported languages: en, ru, uk, de, it, fr, es, zh-hans, ja. Regional language tags and quality weights are accepted; unsupported or omitted values use English. (optional, default to 'en')
    ...
    public function listDataBalancesRequest($limit = null, $offset = null, $acceptLanguage = null, string $contentType = self::contentTypes['listDataBalances'][0])
    {
        ...
        $resourcePath = '/providers/data-balances';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
