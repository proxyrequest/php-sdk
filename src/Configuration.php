...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.proxyrequest.com/api/v1';
    ...
    {
        $report  = 'PHP SDK (ProxyRequest) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                ...
                "description" => "API endpoint for the selected deployment.",
                "variables" => [
                    "host" => [
                        "description" => "API hostname assigned to the deployment.",
                        "default_value" => "api.proxyrequest.com",
                    ]
                ]
            ]
        ];
