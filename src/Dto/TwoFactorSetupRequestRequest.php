...
/**
 * TwoFactorSetupRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class TwoFactorSetupRequestRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TwoFactorSetupRequestRequest';
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling TwoFactorSetupRequestRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCredential($credential)
    {
        ...
        if ((mb_strlen($credential) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credential when calling TwoFactorSetupRequestRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TwoFactorSetupRequestRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{6}$/", ObjectSerializer::toString($code)))) {
            throw new \InvalidArgumentException("invalid value for \$code when calling TwoFactorSetupRequestRequest., must conform to the pattern /^[0-9]{6}$/.");
        }
