...
class TwoFactorDisableRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TwoFactorDisableRequest';
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TwoFactorDisableRequest., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TwoFactorDisableRequest., must be bigger than or equal to 6.');
        }
