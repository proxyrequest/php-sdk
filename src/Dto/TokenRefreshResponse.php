...
/**
 * TokenRefreshResponse Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class TokenRefreshResponse extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TokenRefreshResponse';
     ...
     * Sets access
     *
     * @param string $access New access token for the same account session.
     *
     * @return self
     */
