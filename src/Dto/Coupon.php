 ...
 */
class Coupon extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['redeemedCount'] === null) {
            $invalidProperties[] = "'redeemedCount' can't be null";
        }
        ...
        if ($this->container['stats'] === null && !$this->isNullableSetToNull('stats')) {
            $invalidProperties[] = "'stats' is required";
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Coupon., must be smaller than or equal to 36.');
        }
     ...
     * Sets redeemedCount
     *
     * @param int $redeemedCount redeemedCount
     *
     * @return self
     */
    public function setRedeemedCount($redeemedCount)
    {
        if (is_null($redeemedCount)) {
            throw new \InvalidArgumentException('non-nullable redeemedCount cannot be null');
        }
