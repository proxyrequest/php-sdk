...
/**
 * TelegramLinkResponse Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class TelegramLinkResponse extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TelegramLinkResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('botUrl', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['botUrl'] === null) {
            $invalidProperties[] = "'botUrl' can't be null";
        }
    ...
    {
        return $this->container['botUrl'];
    }

    /**
     * Sets botUrl
     *
     * @param string $botUrl botUrl
     *
     * @return self
     */
    ...
    {
        if (is_null($botUrl)) {
            throw new \InvalidArgumentException('non-nullable botUrl cannot be null');
        }
        $this->container['botUrl'] = $botUrl;
