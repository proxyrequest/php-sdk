...
/**
 * PaginatedAffiliateRewardList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedAffiliateRewardList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedAffiliateRewardList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\AffiliateReward[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\AffiliateReward[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\AffiliateReward[] $results results
     *
     * @return self
     */
