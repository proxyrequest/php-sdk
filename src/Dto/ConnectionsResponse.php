...
/**
 * ConnectionsResponse Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionsResponse extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConnectionsResponse';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\ConnectionRecord[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\ConnectionRecord[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\ConnectionRecord[] $results results
     *
     * @return self
     */
