 ...
 */
class CouponCreateRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets code
     *
     * @param string|null $code Leave empty to auto-generate a code
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 30)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CouponCreateRequest., must be smaller than or equal to 30.');
        }
