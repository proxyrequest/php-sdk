 ...
 */
class PaymentLinkResponse extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paymentUrl'] === null) {
            $invalidProperties[] = "'paymentUrl' can't be null";
        }
     ...
     * Sets paymentUrl
     *
     * @param string $paymentUrl Hosted checkout URL for the pending invoice.
     *
     * @return self
     */
