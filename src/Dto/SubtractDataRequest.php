...
/**
 * SubtractDataRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class SubtractDataRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SubtractDataRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['data'] < 1)) {
            $invalidProperties[] = "invalid value for 'data', must be bigger than or equal to 1.";
        }
    ...
    public function setData($data)
    {
        ...
        if (($data < 1)) {
            throw new \InvalidArgumentException('invalid value for $data when calling SubtractDataRequest., must be bigger than or equal to 1.');
        }
