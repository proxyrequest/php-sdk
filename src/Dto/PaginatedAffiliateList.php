...
/**
 * PaginatedAffiliateList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedAffiliateList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedAffiliateList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\Affiliate[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\Affiliate[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\Affiliate[] $results results
     *
     * @return self
     */
