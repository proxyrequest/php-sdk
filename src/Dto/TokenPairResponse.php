...
/**
 * TokenPairResponse Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class TokenPairResponse extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TokenPairResponse';
     ...
     * Sets token
     *
     * @param string $token Short-lived access token used in the Authorization header.
     *
     * @return self
     */
     ...
     * Sets refresh
     *
     * @param string $refresh Long-lived token used to request a new access token.
     *
     * @return self
     */
