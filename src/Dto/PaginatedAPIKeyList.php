...
/**
 * PaginatedAPIKeyList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedAPIKeyList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedAPIKeyListList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\APIKeyList[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\APIKeyList[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\APIKeyList[] $results results
     *
     * @return self
     */
