 ...
 */
class PaginatedWebhookList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedWebhookListList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\WebhookList[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\WebhookList[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\WebhookList[] $results results
     *
     * @return self
     */
