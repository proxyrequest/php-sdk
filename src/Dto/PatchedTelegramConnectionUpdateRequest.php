...
/**
 * PatchedTelegramConnectionUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
...
class PatchedTelegramConnectionUpdateRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PatchedTelegramConnectionUpdateRequest';
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) > 8)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling PatchedTelegramConnectionUpdateRequest., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($locale) < 1)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling PatchedTelegramConnectionUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling PatchedTelegramConnectionUpdateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($timezone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling PatchedTelegramConnectionUpdateRequest., must be bigger than or equal to 1.');
        }
