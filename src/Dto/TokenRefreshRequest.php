...
/**
 * TokenRefreshRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class TokenRefreshRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TokenRefreshRequestRequest';
     ...
     * Sets refresh
     *
     * @param string $refresh A valid refresh token.
     *
     * @return self
     */
    public function setRefresh($refresh)
    {
        ...
        if ((mb_strlen($refresh) < 1)) {
            throw new \InvalidArgumentException('invalid length for $refresh when calling TokenRefreshRequest., must be bigger than or equal to 1.');
        }
