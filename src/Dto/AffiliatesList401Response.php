...
/**
 * AffiliatesList401Response Class Doc Comment
 *
 * @category Class
 * @description Validation and API error payload. Field names may be added dynamically; field errors are returned as arrays of human-readable messages.
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AffiliatesList401Response extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'affiliates_list_401_response';
