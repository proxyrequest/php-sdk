 ...
 */
class CouponCalculatePriceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setData($data)
    {
        ...
        if (($data < 1)) {
            throw new \InvalidArgumentException('invalid value for $data when calling CouponCalculatePriceRequest., must be bigger than or equal to 1.');
        }
