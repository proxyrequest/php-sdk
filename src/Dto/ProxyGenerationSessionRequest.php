...
/**
 * ProxyGenerationSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
...
class ProxyGenerationSessionRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProxyGenerationSessionRequest';
     ...
     * Sets ttl
     *
     * @param int|null $ttl Sticky session lifetime in seconds. The accepted range is configured per deployment.
     *
     * @return self
     */
