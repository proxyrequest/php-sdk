...
/**
 * PaginatedPackageList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedPackageList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedPackageList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\Package[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\Package[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\Package[] $results results
     *
     * @return self
     */
