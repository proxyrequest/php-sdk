...
/**
 * AddDataRequest Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class AddDataRequest extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AddDataRequest';
    ...
    public function setData($data)
    {
        ...
        if (($data < 1)) {
            throw new \InvalidArgumentException('invalid value for $data when calling AddDataRequest., must be bigger than or equal to 1.');
        }
