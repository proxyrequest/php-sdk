...
/**
 * PaginatedLocationASNRecordList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedLocationASNRecordList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedLocationASNRecordList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\LocationASNRecord[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\LocationASNRecord[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\LocationASNRecord[] $results results
     *
     * @return self
     */
