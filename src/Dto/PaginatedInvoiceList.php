...
/**
 * PaginatedInvoiceList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
...
class PaginatedInvoiceList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedInvoiceList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\Invoice[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\Invoice[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\Invoice[] $results results
     *
     * @return self
     */
