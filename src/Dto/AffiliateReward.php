...
/**
 * AffiliateReward Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class AffiliateReward extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AffiliateReward';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['priceTotal'] === null) {
            $invalidProperties[] = "'priceTotal' can't be null";
        }
        ...
        if ($this->container['commissionAmount'] === null) {
            $invalidProperties[] = "'commissionAmount' can't be null";
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling AffiliateReward., must be smaller than or equal to 36.');
        }
     ...
     * Sets priceTotal
     *
     * @param int $priceTotal priceTotal
     *
     * @return self
     */
    ...
    public function setData($data)
    {
        ...
        if (($data > 1000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $data when calling AffiliateReward., must be smaller than or equal to 1000000000000000.');
        }
        if (($data < 0)) {
            throw new \InvalidArgumentException('invalid value for $data when calling AffiliateReward., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $commissionAmount commissionAmount
     *
     * @return self
     */
