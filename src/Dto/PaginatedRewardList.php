...
/**
 * PaginatedRewardList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedRewardList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedRewardList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\Reward[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\Reward[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\Reward[] $results results
     *
     * @return self
     */
