...
/**
 * PaginatedCouponShortList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedCouponShortList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedCouponShortList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\CouponShort[]'
    ];
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\CouponShort[] $results results
     *
     * @return self
     */
