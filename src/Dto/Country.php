 ...
 */
class Country extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Country., must be smaller than or equal to 36.');
        }
     ...
     * Sets code
     *
     * @param string $code Two-letter ISO 3166-1 alpha-2 country code. Must be unique. us de fr
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Country., must be smaller than or equal to 10.');
        }
     ...
     * Sets name
     *
     * @param string $name English display name of the country used across the admin and API responses.
     *
     * @return self
     */
     ...
     * Sets originalName
     *
     * @param string|null $originalName Native-language name of the country as it appears in the source data. Deutschland Français
     *
     * @return self
     */
    public function setOriginalName($originalName)
    {
        ...
        if ((mb_strlen($originalName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $originalName when calling Country., must be smaller than or equal to 255.');
        }
