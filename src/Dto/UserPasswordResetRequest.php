 ...
 */
class UserPasswordResetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets packageId
     *
     * @param string|null $packageId Package whose proxy password should be rotated. Required only when package-based authentication is enabled.
     *
     * @return self
     */
