...
/**
 * PaginatedContinentList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedContinentList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedContinentList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\Continent[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\Continent[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\Continent[] $results results
     *
     * @return self
     */
