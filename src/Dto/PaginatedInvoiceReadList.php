...
/**
 * PaginatedInvoiceReadList Class Doc Comment
 *
 * @category Class
 * @package  ProxyRequest
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedInvoiceReadList extends \ProxyRequest\Support\AdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedInvoiceReadList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\ProxyRequest\Dto\InvoiceRead[]'
    ];
     ...
     * Gets results
     *
     * @return \ProxyRequest\Dto\InvoiceRead[]
     */
     ...
     * Sets results
     *
     * @param \ProxyRequest\Dto\InvoiceRead[] $results results
     *
     * @return self
     */
